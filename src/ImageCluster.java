...
//            System.out.println("(" + center[i].r + "," + center[i].g + "," + center[i].b + ")");
    ...
    {
        double distance = 0;
        distance = Math.sqrt(Math.pow((first.r - second.r), 2) + Math.pow((first.g - second.g), 2) + Math.pow((first.b - second.b), 2));
        return distance;
    }
...
//            System.out.println(i + ":" + centerSum[i].group + ":" + centerSum[i].r + ":" + centerSum[i].g + ":" + centerSum[i].b);
    ...
    private void ImagedataOut(String path)
    {
        ...
        Color c3 = new Color(127, 127, 127);
        Color c4 = new Color(255, 165, 0);
        Color c5 = new Color(255, 94, 247);
        ...
        for (int i = 0; i < source.length; i++)
        {
            for (int j = 0; j < source[0].length; j++)
            {
                ...
                else if (source[i][j].group == 5)
                {
                    nbi.setRGB(i, j, c5.getRGB());
                }
    ...
    //进行kmeans计算的核心函数
    public void kmeans(String path, int k, int m, String output)
    {
...
//                System.out.println("(" + center[i].r + "," + center[i].g + "," + center[i].b + ")");
            ...
            System.out.println("第" + level + "次迭代完成");
        }
        clusterSet();
...
//        ic.kmeans("C:\\Users\\Administrator\\Documents\\testInput.jpg", 4, 5000, "c:\\5000.jpg");
//        new Thread(() -> ic.kmeans("C:\\Users\\Administrator\\Documents\\testInput3.png", 3, 5000, "c:\\5000_334_3.jpg")).start();
        new Thread(() -> ic.kmeans("C:\\Users\\Administrator\\Documents\\testInput3.png", 6, 7500, "c:\\7500_334_6.jpg")).start();
    }
